...
static const int hiddenbar_tags[]             = { 1, 2 };
...
static const Key keys[] = {
    ...
    { MODKEY,               XK_Return,               spawn,          SHCMD("firefox") },
    { MODKEY,               XK_e,		                 spawn,          SHCMD("st -e yazi") },
    { MODKEY,               XK_d,                    spawn,          SHCMD("rofi -show run") },
    { MODKEY|ShiftMask,     XK_Return,               spawn,          SHCMD("firefox -P Work") },
    { MODKEY,               XK_a,                    spawn,          SHCMD("~/bin/wm/passmenu") },
    { MODKEY|ShiftMask,     XK_s,                    spawn,          SHCMD("~/bin/wm/screenkey") },
    { MODKEY,               XK_r,                    spawn,          SHCMD("~/bin/wm/recording") },
    { MODKEY,               XK_c,                    spawn,          SHCMD("st -t numbat -e numbat") },
    { MODKEY,               XK_s,                    spawn,          SHCMD("~/bin/wm/greenclip-show") },
