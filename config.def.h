...
static const int hiddenbar_tags[]             = { -1 };
...
static const Rule rules[] = {
    ...
    { "st-256color",         NULL,       "bitwarden",0,         0,            -1,           -1 },
};
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,     XK_Return,               spawn,          SHCMD("brave-origin --profile-directory='Work'") },
    { MODKEY,               XK_Return,               spawn,          SHCMD("brave-origin --profile-directory='Personal'") },
    ...
    { MODKEY,               XK_o,                    spawn,          SHCMD("~/bin/wm/bw-menu new") },
    ...
    { 0,                    XF86XK_Tools,            spawn,          SHCMD("~/bin/wm/take-screenshots -m select -s clip") },
